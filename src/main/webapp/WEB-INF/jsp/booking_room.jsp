			...
			<tbody>
				<c:forEach items="${bookingRoomDtos}" var="bookingRoomDto">
					<tr>
						...
						<td><a href="/JavaWeb/bookingroom/update?updateId=${ bookingRoomDto.bookingId }" class="button-success pure-button">Update</a></td>
						<td><a href="/JavaWeb/bookingroom?deleteId=${ bookingRoomDto.bookingId }" class="button-error pure-button">Delete</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
